...
const QuestionTable = () => {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        const response = await axios.get("http://https://peninhand-quizz.onrender.com/questions");
  ...
  const handleUpdate = async () => {
    ...
    try {
      const response = await axios.put(
        `http://https://peninhand-quizz.onrender.com/questions/${selectedQuestion._id}`,
        updatedData
      );
